...
const CERTIFICATIONS = [
  {
    ...
    year: '2026',
    credential: 'Credential ID • add here',
    desc: 'Replace this template with your actual certificate details, issuer, and verification link.',
    tags: ['Verified', 'Online Course', 'Credential ID'],
    image: '',
  },
  {
    num: '02',
    title: 'Add Another Certificate',
    issuer: 'Bootcamp / Academy',
    type: 'Professional Certificate',
    year: '2026',
    credential: 'Issued with certificate link',
    desc: 'Use this slot for bootcamps, specializations, workshops, or training completions.',
    tags: ['Workshop', 'Training', 'Portfolio'],
    image: '',
  },
  {
    num: '03',
    title: 'Add License or Specialization',
    issuer: 'Organization / University',
    type: 'License',
    year: '2026',
    credential: 'Enter the credential number',
    desc: 'A clean place for licenses, specialization badges, and professional certifications.',
    tags: ['License', 'Specialization', 'Badge'],
    image: '',
  },
  {
    num: '04',
    title: 'Add Event or Completion Badge',
    issuer: 'Conference / Community',
    type: 'Completion Badge',
    year: '2026',
    credential: 'Verification link available',
    desc: 'Drop in any achievement that deserves a spotlight, from hackathons to community programs.',
    tags: ['Badge', 'Achievement', 'Community'],
    image: '',
  },
]
        ...
        <div className="cert-header">
          ...
          <div className="cert-copy-wrap">
            <p className="cert-copy">
              A cinematic vault for your course certificates, licenses, and badges — ready to be filled with your real achievements.
            </p>
